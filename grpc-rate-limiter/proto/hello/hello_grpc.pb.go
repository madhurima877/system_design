...
type GreeterClient interface {
	SayHello(ctx context.Context, in *GreeterRequest, opts ...grpc.CallOption) (*GreeterResponse, error)
}
...
func (c *greeterClient) SayHello(ctx context.Context, in *GreeterRequest, opts ...grpc.CallOption) (*GreeterResponse, error) {
...
func (UnimplementedGreeterServer) SayHello(context.Context, *GreeterRequest) (*GreeterResponse, error) {
