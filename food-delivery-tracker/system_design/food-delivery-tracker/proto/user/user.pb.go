...
const file_proto_user_proto_rawDesc = "" +
	"\n" +
	"\x10proto/user.proto\x12\x04user\"7\n" +
	...
	"\vUserService\x123\n" +
	"\n" +
	"CreateUser\x12\x11.user.UserRequest\x1a\x12.user.UserResponseB0Z.system_design/food-delivery-tracker/proto/userb\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	...
	1, // 1: user.UserService.CreateUser:output_type -> user.UserResponse
